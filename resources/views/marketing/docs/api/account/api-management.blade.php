<x-marketing-docs-layout :marketingPage="$marketingPage">
  <div class="py-16">
    <x-docs.h1 title="API management" />
    ...
    <div class="mb-10 grid grid-cols-1 gap-6 border-b border-gray-200 pb-10 sm:grid-cols-2">
      <div>
        <x-docs.h2 id="get-the-list-of-api-keys-in-the-account" title="Get the list of API keys in the account" />
        ...
        <x-docs.response-attributes>
          <x-docs.attribute name="type" type="string" description="The object type. Always 'api_key'." />
          <x-docs.attribute name="id" type="integer" description="The ID of the API key." />
          <x-docs.attribute name="attributes" type="object" description="The attributes of the API key." />
          <x-docs.attribute name="name" type="string" description="The name of the API key." />
          <x-docs.attribute name="token" type="string" description="The API key. Always null in this endpoint." />
          <x-docs.attribute name="last_used_at" type="string" description="The date and time the API key was last used, in Unix timestamp format." />
          <x-docs.attribute name="created_at" type="integer" description="The date and time the object was created, in Unix timestamp format." />
          <x-docs.attribute name="updated_at" type="integer" description="The date and time the object was last updated, in Unix timestamp format." />
          <x-docs.attribute name="links" type="object" description="The links of the API key." />
          <x-docs.attribute name="self" type="string" description="The URL of the API key." />
        </x-docs.response-attributes>
      </div>
      <div>
    ...
    <div class="mb-10 grid grid-cols-1 gap-6 border-b border-gray-200 pb-10 sm:grid-cols-2">
      <div>
        <x-docs.h2 id="get-an-api-key" title="Get an API key" />
        <p class="mb-10">This endpoint gets an API key. It will return the API key in the response.</p>

        <!-- url parameters -->
        <x-docs.url-parameters>
          <x-docs.attribute required name="id" type="integer" description="The ID of the API key." />
        </x-docs.url-parameters>
        ...
        <x-docs.response-attributes>
          ...
          <x-docs.attribute name="attributes" type="object" description="The attributes of the API key." />
          <x-docs.attribute name="name" type="string" description="The name of the API key." />
          <x-docs.attribute name="token" type="string" description="The API key." />
          <x-docs.attribute name="last_used_at" type="string" description="The date and time the API key was last used, in Unix timestamp format." />
          <x-docs.attribute name="created_at" type="integer" description="The date and time the object was created, in Unix timestamp format." />
          <x-docs.attribute name="updated_at" type="integer" description="The date and time the object was last updated, in Unix timestamp format." />
          <x-docs.attribute name="links" type="object" description="The links of the API key." />
    ...
    <div class="mb-10 grid grid-cols-1 gap-6 border-b border-gray-200 pb-10 sm:grid-cols-2">
      <div>
        <x-docs.h2 id="create-a-new-api-key" title="Create a new API key" />
        ...
        <!-- query parameters -->
        <x-docs.query-parameters>
          <x-docs.attribute required name="label" type="string" description="The name of the API key. Maximum 255 characters." />
        </x-docs.query-parameters>
    ...
    <div class="mb-10 grid grid-cols-1 gap-6 sm:grid-cols-2">
      <div>
        <x-docs.h2 id="delete-an-api-key" title="Delete an API key" />
      ...
      <div>
        <x-docs.code title="/api/settings/api/{id}" verb="DELETE" verbClass="text-red-700">
