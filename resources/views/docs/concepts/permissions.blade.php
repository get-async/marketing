<x-marketing-docs-layout>
  <div class="grid grid-cols-1 gap-x-16 lg:grid-cols-[1fr_250px]">
    <div class="py-16 sm:border-r sm:border-gray-200 sm:pr-10">
      ...
      <x-docs.h2 id="permissions" title="Permissions (the building blocks)" />
      ...
      <x-docs.h2 id="roles" title="Roles (bundles of permissions)" />
      ...
      <x-docs.h2 id="groups" title="Groups (collections of people)" />
