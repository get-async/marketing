<x-marketing-docs-layout :marketingPage="$marketingPage">
  <div class="py-16">
    ...
    <div class="mb-10 grid grid-cols-1 gap-6 border-b border-gray-200 pb-10 sm:grid-cols-2">
      <div>
        <x-docs.h2 id="get-the-logs-of-the-current-user" title="Get the logs of the current user" />
        <p class="mb-2">This endpoint gets the logs of the current user. This is useful to understand what the user has done in the account.</p>
        <p class="mb-10">
          This call is
        ...
        <x-docs.query-parameters>
          <x-docs.attribute name="page" type="integer" description="The page number to retrieve. The first page is 1. If you don't provide this parameter, the first page will be returned." />
        </x-docs.query-parameters>

        <!-- response attributes -->
        <x-docs.response-attributes>
          <x-docs.attribute name="type" type="string" description="The type of the resource." />
          <x-docs.attribute name="id" type="string" description="The ID of the log." />
          <x-docs.attribute name="attributes" type="object" description="The attributes of the log." />
          <x-docs.attribute name="attributes.user_name" type="string" description="The name of the Person the action was performed on." />
          <x-docs.attribute name="attributes.action" type="string" description="The action that was performed. There are many actions." />
          <x-docs.attribute name="attributes.description" type="string" description="The description of the action." />
          ...
          <x-docs.attribute name="links" type="object" description="The links to access the log." />
        </x-docs.response-attributes>
      </div>
      <div>
        <x-docs.code title="/api/settings/logs" verb="GET" verbClass="text-blue-700">
    ...
    <div class="mb-10 grid grid-cols-1 gap-6 sm:grid-cols-2">
      <div>
        <x-docs.h2 id="get-a-log" title="Get a specific log" />
        <p class="mb-10">This endpoint gets a specific log.</p>

        <!-- url parameters -->
        <x-docs.url-parameters>
          <x-docs.attribute required name="log" type="integer" description="The ID of the log to get." />
        </x-docs.url-parameters>
        ...
        <x-docs.response-attributes>
          ...
          <x-docs.attribute name="id" type="string" description="The ID of the log." />
          <x-docs.attribute name="attributes" type="object" description="The attributes of the log." />
          <x-docs.attribute name="attributes.name" type="string" description="The name of the Person the action was performed on." />
          <x-docs.attribute name="attributes.action" type="string" description="The action that was performed. There are many actions." />
          <x-docs.attribute name="attributes.description" type="string" description="The description of the action." />
          <x-docs.attribute name="attributes.created_at" type="integer" description="The date and time the object was created, in Unix timestamp format." />
          <x-docs.attribute name="attributes.updated_at" type="integer" description="The date and time the object was last updated, in Unix timestamp format." />
      ...
      <div>
        <x-docs.code title="/api/settings/logs/{log}" verb="GET" verbClass="text-blue-700">
          @include('docs.api.partials.log-response')
        </x-docs.code>
      </div>
    </div>
